...
//		jwtAccessTokenConverter.setSigningKey("SDFDSSDFSDFSFSFkjsgdfhjdsgfkjsgfjkgKJG87678rewmbfnbiufwey");
	...
	private KeyPair keyPair() {
		var keyStorePass = jwtKeyStoreProperties.getPassword(); // colocar numa variável de ambiente
